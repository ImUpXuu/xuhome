...
PROXY_BASE = "https://xu-1357447520.cos.ap-beijing.myqcloud.com/images/img"  # 图片代理基础 URL
```
...
```javascript
const PROXY_BASE = 'https://xu-1357447520.cos.ap-beijing.myqcloud.com/images/img';  // 改为你的地址
```
...
[
  {
    ...
    "month": 4,
    "count": 15,
    "url": "https://xu-1357447520.cos.ap-beijing.myqcloud.com/images/2026/4/index.json"
  }
]
```
