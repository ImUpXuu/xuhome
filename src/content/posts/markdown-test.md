...
date: "2026-06-02"
description: "这是一篇包含各?Markdown 元素的测试文章，用于展示博客对不同排版格式的支持效果，包括代码块、表格、引用等?"
...
| 框架 | 语言 | 核心特点 | 性能评分 |
| :--- | :---: | :---: | ---: |
| React | JS/TS | UI 组件? 虚拟 DOM | 8/10 |
| Vue | JS/TS | 渐进? 双向绑定 | 8/10 |
| Astro | JS/TS | 岛屿架构, MPA | 9/10 |
| Svelte | JS/TS | 编译期优? 无虚?DOM | 10/10 |
...
测试结束。希望这篇包含各种常?Markdown 语法的文章能够全面展示系统的渲染能力?
