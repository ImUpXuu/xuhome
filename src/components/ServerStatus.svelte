...
<div class="bg-white border-4 border-[#0284c7] p-4 sm:p-6 shadow-[6px_6px_0px_0px_#10b981] rounded-sm">
  ...
  <div class="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3 mb-4">
    <div class="bg-[rgba(250,248,245,0.25)] border-2 border-[#0284c7]/20 rounded-sm px-3 py-2">
  ...
  <div class="bg-[rgba(250,248,245,0.25)] border-2 border-[#0284c7]/20 rounded-sm p-2">
