    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 pointer-events-none">
          ...
          <div className="absolute bottom-0 left-0 sm:bottom-24 sm:left-auto sm:right-6 w-full sm:w-[480px] md:w-[560px] h-[60dvh] sm:h-[600px] md:h-[680px] bg-[rgba(250,248,245,0.35)] dark:bg-slate-800 shadow-2xl sm:rounded-md flex flex-col pointer-events-auto border-t-4 sm:border-4 border-[#0284c7] overflow-hidden">
            {/* Header */}
            ...
            {/* Chat Area */}
            <div ref={chatAreaRef} className="flex-1 overflow-y-auto custom-scrollbar p-3 sm:p-4 space-y-3 sm:space-y-4 bg-[rgba(250,248,245,0.35)] dark:bg-slate-900">
